...
/**
 * Custom exception resolver for LicensedProduct version 2 services to generate Soap fault detail element
 * in Soap fault as it is not supported by Spring out of the box. Constructs the JAXB Exception element from
 * exception and marshals into Soap fault raw xml
 *
 * @author nlloyd
 */
public class LicensedProductV2SoapFaultExceptionResolver extends SoapFaultAnnotationExceptionResolver {
	...
	@Override
    protected void customizeFault(final Object endpoint,
                                  final Exception ex,
