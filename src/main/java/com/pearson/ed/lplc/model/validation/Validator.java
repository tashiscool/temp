...
public interface Validator {
	/**
	 * Performs validation on the domain objects. An object passes validation if it obeys all of the business constraint
	 * rules.
	 * 
	...
	/**
	 * Creates a list of errors that occurred during the most recent call to validate.
	 * 
