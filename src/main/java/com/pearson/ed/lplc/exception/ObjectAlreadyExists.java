...
public class ObjectAlreadyExists extends LPLCBaseException {
	...
	/**
	 * Constructs a new ObjectAlreadyExists exception with the passed message and cause.
	 * 
	 * @param message
	...
	/**
	 * Constructs a new ObjectAlreadyExists exception with the passed message.
	 * 
	 * @param message
	 *            the message for the exception.
	 */
	...
	/**
	 * Constructs a new ObjectAlreadyExists exception with the passed cause. The message is automatically generated from
	 * the cause.
	 * 
	 * @param cause
	 *            the cause of the exception.
