...
public class LicensePoolExpiredException extends LicensePoolUnavailableException {
	...
	/**
	 * The default constructor for LicensePoolExpiredException. The message is null and
	...
	/**
	 * Constructs a new LicensePoolExpiredException with the passed cause. The message is
