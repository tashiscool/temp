...
public class LicensePoolForFutureException extends LPLCBaseException {
	...
	/**
	 * The default constructor for LicensePoolForFutureException. The message is null and the cause is unspecified.
	 */
	...
	/**
	 * Constructs a new LicensePoolForFutureException with the passed cause. The message is automatically generated from
	 * the cause.
	 * 
	 * @param cause
	 *            the cause of the exception.
