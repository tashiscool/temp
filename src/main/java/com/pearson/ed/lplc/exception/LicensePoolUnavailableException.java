...
public class LicensePoolUnavailableException extends LPLCBaseException {
	...
	/**
	 * The default constructor for LicensePoolUnavailableException. The message is null and
	...
	/**
	 * Constructs a new LicensePoolUnavailableException with the passed cause. The message is
