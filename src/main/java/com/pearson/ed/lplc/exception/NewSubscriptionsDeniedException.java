...
public class NewSubscriptionsDeniedException extends LicensePoolUnavailableException {
	...
	/**
	 * The default constructor for NewSubscriptionsDeniedException. The message is null and
	...
	/**
	 * Constructs a new NewSubscriptionsDeniedException with the passed cause. The message is
