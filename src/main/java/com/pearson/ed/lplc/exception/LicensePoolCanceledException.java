...
public class LicensePoolCanceledException extends LPLCBaseException{
	...
	/**
	 * The default constructor for LicensePoolCanceledException. The message is null and
	...
	/**
	 * Constructs a new LicensePoolCanceledException with the passed cause. The message is
