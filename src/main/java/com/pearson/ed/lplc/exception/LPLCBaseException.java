...
/**
 * Base exception class for all LPLC exceptions. All exceptions for the LPLC will
 * be descended from this one.
 * 
 * @author UCRUZFI
 * 
 */
public class LPLCBaseException extends RUMBABaseException {
	...
	/**
	 * The default constructor for LPLCBaseException. The message is null and
	...
	/**
	 * Constructs a new LPLCBaseException with the passed cause. The message is
