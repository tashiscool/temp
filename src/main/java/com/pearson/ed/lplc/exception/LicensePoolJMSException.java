...
public class LicensePoolJMSException extends LPLCBaseException {
	...
	/**
	 * The default constructor for LicensePoolJMSException. The message is null and the cause is unspecified.
	 */
	...
	/**
	 * Constructs a new LicensePoolJMSException with the passed cause. The message is automatically generated from the
	 * cause.
	 * 
	 * @param cause
	 *            the cause of the exception.
