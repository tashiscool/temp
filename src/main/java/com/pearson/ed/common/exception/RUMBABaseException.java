...
public class RUMBABaseException extends RuntimeException {
	...
	/**
	 * The default constructor for RUMBABaseException. The message is null and the cause is unspecified.
	 */
	...
	/**
	 * Constructs a new RUMBABaseException with the passed cause. The message is automatically generated from the cause.
	 * 
	 * @param cause
